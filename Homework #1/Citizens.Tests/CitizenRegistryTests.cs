namespace Citizens.Tests
{
    ...
    {
        private ICitizenRegistry _registry;
        private readonly DateTime _testBirthDate = new DateTime(1991, 8, 24);
        ...
        {
            base.Initialize();
            _registry = CreateCitizenRegistry();
        }
        ...
        public void Register_ForAlreadyRegisteredVatId_ThrowsInvalidOperationException()
        {
            ...
            _registry.Register(citizen1);

            _registry.Register(citizen2);
        }
        ...
        {
            var citizen = CitizenBuilder.NewMan().WithDate(_testBirthDate).Build();
            _registry.Register(citizen);
        ...
        {
            var citizen = CitizenBuilder.NewWoman().WithDate(_testBirthDate).Build();
            _registry.Register(citizen);
        ...
        {
            var w1 = CitizenBuilder.NewWoman().WithDate(_testBirthDate).Build();
            var w2 = CitizenBuilder.NewWoman().WithDate(_testBirthDate).Build();
            _registry.Register(w1);
            _registry.Register(w2);
        ...
        public void Indexer_WithRegisteredVatId_ReturnsCitizenFoundByVatId()
        {
            ...
            ICitizen foundCitizen = _registry[citizen.VatId];
        ...
        public void Indexer_WhenCitizenChanges_RegistryHasNoChanges()
        {
            ...
            ICitizen foundCitizen = _registry[id];
        ...
        {
            var result = _registry[null];
        }

        [TestMethod]
        public void Indexer_WithNotRegisteredVatId_ReturnsNull()
        {
            var result = _registry["0123456789"];
